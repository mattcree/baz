...
| The ambient Now playing — cover as the background, stylised VU over it, a feed of facts, all toggle-able; *"a spectrum analyzer or graphic thing with the bars going up and down"* | **spectrum and visual controls shipped; feed deferred; VU removed by owner** | The cover-derived field now sits behind either plain artwork or the rotating jewel case. Cover / Jewel Case are one mutually exclusive foreground choice; Spectrum is an independent full-body background toggle with a gated lock-free sample tap. The four-way Cover / Case / Spectrum / VU selector was tried in the app and rejected on 2026-08-11: *"remove the VU meter... looks bad"*. Design 12's implementation amendment records the replacement. The local facts feed remains unbuilt |
