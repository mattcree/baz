...
4. **A human owns every merge.** Review is real: the maintainer reads, understands, and can defend every change. "The model said so" is never a rationale in a PR discussion; benchmarks, tests, and ADRs are.
